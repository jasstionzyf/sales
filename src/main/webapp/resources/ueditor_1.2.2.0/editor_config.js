...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL||"/taoban-manager/resources/ueditor_1.2.2.0/";//tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/taoban-manager/image1/editor_upload"             //图片上传提交地址
        ,imagePath:"http://img.taoban.com"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
